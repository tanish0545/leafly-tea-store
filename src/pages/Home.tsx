  ...
  return (
    <div className="leafly-app">
      <SEO
        ...
        description="Discover rare single-origin Darjeeling loose leaf green teas, black teas, and oolong teas. Experience mindful brewing rituals and bespoke tea gifting."
        canonicalPath="/"
        schema={homeSchemas}
      />
      <main>
